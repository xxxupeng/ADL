...
# from models.PENet.dataloaders.kitti_loader import *
...
class KITTIDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.training:
            ...
            # position = CoordConv.AddCoordsNp(left_img.shape[0],left_img.shape[1])
            ...
            # augmented, disparity,position = co_transform([left_img, right_img], disparity,position)
